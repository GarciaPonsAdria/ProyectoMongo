/*
 *
 * En este archivo realizaremos los inserts a las distintas bases de datos
 *
 * El primer Insert a cada colección estará expuesto de forma desarrollada en este archivo
 * y explicado en el PDF del proyecto.
 * 
 */
db.Clientes.drop();
